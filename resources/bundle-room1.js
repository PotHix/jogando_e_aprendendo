	...
	setObject:[
		{
			...
			value:{
				...
				{ speed:1, who:"noone", audio:"beep", asking: {intro: true}, talk:["Aqui sera o lugar que voce vai", "testar os seus conhecimentos e", "aprender respondendo perguntas", "inteligentes! Vamos comecar!"]},
					...
					{ speed:1, who:"noone", audio:"beep", asking: {options:["a)", false, "b)", true, "c)", false, "d)", false], answers: true}, talk:["a) 64 reais", "b) 54 reais", "c) 50 reais", "d) 46 reais"]},
					...
					{ speed:1, who:"noone", audio:"beep", asking: {options:["a)", true, "b)", false, "c)", false, "d)", false], answers: true}, talk:["a) um kilo e meio", "b) dois kilos", "c) tres kilos", "d) um kilo"]}
			]
			}
		},{
			object:"tilemaps",
