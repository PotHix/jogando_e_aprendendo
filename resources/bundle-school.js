	...
	setObject:[
		{
			...
			value:{
				...
				scenes:[
					...
					{ speed:1, who:"noone", audio:"beep", asking: {question: true}, talk:["Pegue 2 macas de 4 macas.", "Quantas voce tem agora?"]},
					...
					{ speed:1, who:"noone", audio:"beep", asking: {question: true}, talk:["Qual e o conjunto", "dos numeros naturais?"]},
					{ speed:1, who:"noone", audio:"beep", asking: {options:["a)", "b)", "c)", "d)"], answers:[false, false, false, true], rightAnswerCallback:function(points){ maingame.increaseScore(points); }}, talk:["a) I", "b) J", "c) Z", "d) N"]},
			...
			value:{
				...
				scenes:[
					...
					{ speed:1, who:"noone", audio:"beep", asking: {question: true}, talk:["Nome dado ao aumento da temperatura", "no planeta Terra?"]},
			...
			value:{
				...
				scenes:[
					...
					{ speed:1, who:"noone", audio:"beep", asking: {question: true}, talk:["Qual a linha imaginaria", "que atravessa o Brasil?"]},
