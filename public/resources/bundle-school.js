	...
	setObject:[
		{
			...
			value:{
				...
				scenes:[
					{ speed:1, who:"noone", asking: {intro: true}, talk:["Aqui sera o lugar que voce vai", "testar os seus conhecimentos e", "aprender respondendo perguntas", "inteligentes!"]},
					...
					{ speed:1, who:"noone", asking: {intro: true}, talk:["Muito bem! Entao vamos comecar!"]},
					...
					{ speed:1, who:"noone", asking: {question: true}, talk:["Os faraos eram conhecidos", "em qual civilizacao?"]},
					{ speed:1, who:"noone", asking: {options:["a)", "b)", "c)", "d)"], answers:[false, true, false, false], rightAnswerCallback:function(points){ maingame.increaseScore(points); }}, talk:["a) Grega", "b) Egipicia", "c) Indiana", "d) Maia"]},
					{ speed:1, who:"noone", asking: {question: true}, talk:["Quais destas invencoes", "foram criadas pelos Egipcios?"]},
					{ speed:1, who:"noone", asking: {options:["a)", "b)", "c)", "d)"], answers:[false, false, false, true], rightAnswerCallback:function(points){ maingame.increaseScore(points); }}, talk:["a) irrigacao", "b) seda", "c) polvora", "d) alianca"]},
			...
			value:{
				...
				scenes:[
					...
					{ speed:1, who:"noone", asking: {question: true}, talk:["Pegue 2 macas de 4 macas.", "Quantas voce tem agora?"]},
			...
			value:{
				...
				scenes:[
					...
					{ speed:1, who:"noone", asking: {question: true}, talk:["Indique o substantivo que", "admite dois plurais?"]},
					{ speed:1, who:"noone", asking: {options:["a)", "b)", "c)", "d)"], answers:[false, true, false, false], rightAnswerCallback:function(points){ maingame.increaseScore(points); }}, talk:["a) desvao", "b) verao", "c) demao", "d) irmao"]},
					...
					{ speed:1, who:"noone", asking: {question: true}, talk:["Qual e o encontro", "da palavra Tambem?"]},
					{ speed:1, who:"noone", asking: {options:["a)", "b)", "c)", "d)"], answers:[false, false, true, false], rightAnswerCallback:function(points){ maingame.increaseScore(points); }}, talk:["a) hiato", "b) tritongo", "c) ditongo", "d) nenhum"]},
					{ speed:1, who:"noone", asking: {question: true}, talk:["Qualidade de timido:"]},
					{ speed:1, who:"noone", asking: {options:["a)", "b)", "c)", "d)"], answers:[true, false, false, false], rightAnswerCallback:function(points){ maingame.increaseScore(points); }}, talk:["a) timidez", "b) so", "c) solidao", "d) sozinho"]},
